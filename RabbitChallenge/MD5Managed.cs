...
namespace RabbitChallenge
{
    ...
    ///     By @ameerkat from https://gist.github.com/ameerkat/07a748c9b571289711ebaf61f4b596e9
    /// </summary>
    ...
    internal class MD5Managed
    {
        ...
        public static uint[] Calculate(byte[] input)
        {
            ...
            var length = BitConverter.GetBytes(input.Length * 8); // bit converter returns little-endian
